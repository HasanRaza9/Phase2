...
<input type="hidden" value='<%=request.getParameter("TotalBookedSeats") %>' name="totalBookedSeats">
...
<font color="red"><c:out value="Unable to Search Please contact Technical Support...." /></font>
</c:if>
